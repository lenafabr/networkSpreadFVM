...
CONTAINS  
  ...
  SUBROUTINE RUNDYNAMICSDRIVER(NETP,ACTION)
    ...
    IF (USERESVELEMENTS) THEN
       CALL SETUPNETWORKMESH(MESHP,NETP,MAXMESHSIZE,MINMESHPT,CONC3D,USEGLOBALRESV,GLOBALRESVOL,RESVP)
    ELSE
       CALL SETUPNETWORKMESH(MESHP,NETP,MAXMESHSIZE,MINMESHPT,CONC3D,USEGLOBALRESV,GLOBALRESVOL)
    ENDIF        
